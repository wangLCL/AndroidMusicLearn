...
public class MDTintHelper {
    public static void setTint(@NonNull RadioButton radioButton, @NonNull ColorStateList colors) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Drawable radioDrawable = ContextCompat.getDrawable(radioButton.getContext(), androidx.appcompat.R.drawable.abc_btn_radio_material);
    ...
    public static void setTint(@NonNull RadioButton radioButton, @ColorInt int color) {
        ...
        ColorStateList sl = new ColorStateList(new int[][]{
                ...
                DialogUtils.resolveColor(radioButton.getContext(), androidx.appcompat.R.attr.colorControlNormal),
                color,
                disabledColor,
                disabledColor
        });
    ...
    public static void setTint(@NonNull CheckBox box, @NonNull ColorStateList colors) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Drawable checkDrawable = ContextCompat.getDrawable(box.getContext(), androidx.appcompat.R.drawable.abc_btn_check_material);
    ...
    public static void setTint(@NonNull CheckBox box, @ColorInt int color) {
        ...
        ColorStateList sl = new ColorStateList(new int[][]{
                ...
                DialogUtils.resolveColor(box.getContext(), androidx.appcompat.R.attr.colorControlNormal),
                color,
                disabledColor,
                disabledColor
        });
    ...
    private static ColorStateList createEditTextColorStateList(@NonNull Context context, @ColorInt int color) {
        ...
        colors[i] = DialogUtils.resolveColor(context, androidx.appcompat.R.attr.colorControlNormal);
        i++;
