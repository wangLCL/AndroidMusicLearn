...
public class Config {
    ...
    public static int primaryColorDark(@NonNull Context context) {
        return prefs(context).getInt(KEY_PRIMARY_COLOR_DARK, Util.resolveColor(context, androidx.appcompat.R.attr.colorPrimaryDark, Color.parseColor("#37474F")));
    }

    @ColorInt
    public static int accentColor(@NonNull Context context) {
        return prefs(context).getInt(KEY_ACCENT_COLOR, Util.resolveColor(context, androidx.appcompat.R.attr.colorAccent, Color.parseColor("#263238")));
    }
